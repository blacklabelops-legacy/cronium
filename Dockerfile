...
RUN apk add --update --no-cache --virtual .build-deps \
    ...
    curl -fsSL https://22-112953069-gh.circle-artifacts.com/0/root/crow/application/target/crow-application-0.5-SNAPSHOT.jar -o ${CROW_HOME}/crow-application.jar && \
    # Cleanup
    apk del .build-deps && \
